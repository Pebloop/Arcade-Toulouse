...
__attribute__((deprecated)) EXPORT void* library_create();
 ...
 */
 __attribute__((deprecated)) EXPORT void library_delete(void* library);
 ...
 */
 __attribute__((deprecated)) EXPORT library_info_t library_get_data();
